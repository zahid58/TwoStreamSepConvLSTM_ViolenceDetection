...
def tiny_yolo3_ultralite_mobilenetv3small_body(input_shape, num_anchors, num_classes, alpha=0.25):
    ...
    print('mobilenetv3small output shape:',mobilenetv3small.output_shape)

    return Model(mobilenetv3small.input, [y1,y2, mobilenetv3small.output])
